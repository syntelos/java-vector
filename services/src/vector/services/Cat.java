 ...
 * 
 * In {@link CatService} an input sequence (argv) is constructed
 ...
 */
public enum Cat
    implements vector.data.DataOperator<Cat>
{
    /**
     * 
     */
    ...
    private Cat(boolean required, Class... possibleValues){
    ...
    public String[] evaluate(Object... argv){
        return CatService.Evaluate(argv);
    }
}
