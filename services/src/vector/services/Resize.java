 ...
 * 
 * In {@link ResizeService} an input sequence (argv) is constructed
 ...
 */
public enum Resize
    implements vector.data.DataOperator<Resize>
{
    /**
     * 
     */
    ...
    private Resize(boolean required, Class... possibleValues){
    ...
    public String[] evaluate(Object... argv){
        return ResizeService.Evaluate(argv);
    }
}
