 ...
 * 
 * In {@link CreateService} an input sequence (argv) is constructed
 ...
 */
public enum Create
    implements vector.data.DataOperator<Create>
{
    /**
     * 
     */
    ...
    private Create(boolean required, Class... possibleValues){
    ...
    public String[] evaluate(Object... argv){
        return CreateService.Evaluate(argv);
    }
}
