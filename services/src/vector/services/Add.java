 ...
 * 
 * In {@link AddService} an input sequence (argv) is constructed
 ...
 */
public enum Add
    implements vector.data.DataOperator<Add>
{
    /**
     * 
     */
    ...
    private Add(boolean required, Class... possibleValues){
    ...
    public Iterable<vector.data.DataField<Add>> getMapping(){
        throw new UnsupportedOperationException();
    }
    ...
    public String[] evaluate(Object... argv){
        return AddService.Evaluate(argv);
    }
}
