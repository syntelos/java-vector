 ...
 * 
 * In {@link MoveService} an input sequence (argv) is constructed
 ...
 */
public enum Move
    implements vector.data.DataOperator<Move>
{
    /**
     * 
     */
    ...
    private Move(boolean required, Class... possibleValues){
    ...
    public String[] evaluate(Object... argv){
        return MoveService.Evaluate(argv);
    }
}
