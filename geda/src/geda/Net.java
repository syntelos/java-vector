    ...
    extends vector.Container
{
    ...
    public Net(LineNumberReader in) throws IOException {
        super();
        this.readGeda(in);
    }
    ...
    public Net readGeda(LineNumberReader in) throws IOException {
        this.mark = true;

        final int lno = in.getLineNumber();
        final String line = in.readLine();
        StringTokenizer strtok = new StringTokenizer(line," ");
        if (5 == strtok.countTokens()){
    ...
    public Net writeGeda(OutputStream out) throws IOException {
