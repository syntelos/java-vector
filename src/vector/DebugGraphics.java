    ...
    extends java.awt.Graphics2D
{
    ...
    {
        Debug.trace.printf("[%d] drawImage(%s, %s, %s)%n", this.depth, image0, affineTransform1, imageObserver2);
    ...
    {
        Debug.trace.printf("[%d] drawImage(%s, %s, %d, %d)%n", this.depth, bufferedImage0, bufferedImageOp1, a2, a3);
    ...
    {
        Debug.trace.printf("[%d] drawRenderableImage(%s, %s)%n", this.depth, renderableImage0, affineTransform1);
    ...
    {
        Debug.trace.printf("[%d] drawRenderedImage(%s, %s)%n", this.depth, renderedImage0, affineTransform1);
        this.instance.drawRenderedImage(renderedImage0, affineTransform1);
    }
    public void drawString(String string0, int a1, int a2)
    {
        Debug.trace.printf("[%d] drawString(%s, %d, %d)%n", this.depth, string0, a1, a2);
        this.instance.drawString(string0, a1, a2);
    }
    public void drawString(String string0, float flo1, float flo2)
    {
        Debug.trace.printf("[%d] drawString(%s, %f, %f)%n", this.depth, string0, flo1, flo2);
    ...
    {
        Debug.trace.printf("[%d] drawString(%s, %d, %d)%n", this.depth, attributedCharacterIterator0, a1, a2);
    ...
    {
        Debug.trace.printf("[%d] drawString(%s, %f, %f)%n", this.depth, attributedCharacterIterator0, flo1, flo2);
    ...
    {
        Debug.trace.printf("[%d] drawImage(%s, %d, %d, %s)%n", this.depth, image0, a1, a2, imageObserver3);
    ...
    {
        Debug.trace.printf("[%d] drawImage(%s, %d, %d, %d, %d, %s)%n", this.depth, image0, a1, a2, a3, a4, imageObserver5);
    ...
    {
        Debug.trace.printf("[%d] drawImage(%s, %d, %d, %s, %s)%n", this.depth, image0, a1, a2, color3, imageObserver4);
    ...
    {
        Debug.trace.printf("[%d] drawImage(%s, %d, %d, %d, %d, %s, %s)%n", this.depth, image0, a1, a2, a3, a4, color5, imageObserver6);
    ...
    {
        Debug.trace.printf("[%d] drawImage(%s, %d, %d, %d, %d, %d, %d, %d, %d, %s)%n", this.depth, image0, a1, a2, a3, a4, a5, a6, a7, a8, imageObserver9);
    ...
    {
        Debug.trace.printf("[%d] drawImage(%s, %d, %d, %d, %d, %d, %d, %d, %d, %s, %s)%n", this.depth, image0, a1, a2, a3, a4, a5, a6, a7, a8, color9, imageObserver10);
