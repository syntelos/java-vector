...

    /**
     * A hard coded scene graph is generated by a method named build.
     * The method returns <code>this</code>, in the type of the class
     * in which the method is defined.  The method may have arguments.
     * 
        ...
        extends Component
    {
        ...
        /**
         * Call this method from Display show immediately following
         * add and init.
         * 
         * <p> A hard coded scene graph is generated when this
         * component is added to the scene graph by Display show. </p>
         * 
         * @see vector.dialog.Menu
         * @see vector.Display
         */
        public interface InShow
            extends Build
        {
            public Build.InShow build();
        }
    }
    /**
     * Methods implemented by components that may employ an
     * interactive border.
     */
